...
correrMutaciones({
  ...
  manuales: [
    ...
    { nombre: '"Cargar importe" se enlaza con 3 decimales (el precio por unidad deja de cortarse)',
      de: '      enlazarCampoNumero(input, { decimales: 2 })', a: '      enlazarCampoNumero(input, { decimales: 3 })' },
