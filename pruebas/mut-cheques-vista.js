...
correrMutaciones({
  ...
  funciones: ['htmlCartera', 'pintarSelectorBancos', 'pintarFiltrosCheques', 'htmlFilaCheque', 'htmlAccionCheque'],
  manuales: [
    ...
    { nombre: 'Dar salida se ofrece con la cobranza por controlar',
      de: "if (ch.estado === 'en_cartera' && cob?.estado === 'procesada') {", a: "if (ch.estado === 'en_cartera') {" },
    { nombre: 'los botones se ofrecen sin la tarea procesar',
      de: "      if (!puedeProcesar()) return ''\n      if (ch.estado === 'en_cartera'", a: "      if (ch.estado === 'en_cartera'" },
