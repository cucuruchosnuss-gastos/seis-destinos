...
correrMutaciones({
  ...
  manuales: [
    ...
    { nombre: '"Salió" compara contra "asentada"',
      de: "ch.estado === 'en_cartera' && cob?.estado === 'procesada'", a: "ch.estado === 'en_cartera' && cob?.estado === 'asentada'" },
    // ── Cifras de cabecera ───────────────────────────────────────────────────
    ...
    { nombre: 'no se recalcula tras asentar / reabrir / anular (accionSimple sin refrescar)',
      de: '        await abrirDetalle(params.p_id, { origen: estado.detalleOrigen })\n        await refrescarListado()',
      a: '        await abrirDetalle(params.p_id, { origen: estado.detalleOrigen })' },
