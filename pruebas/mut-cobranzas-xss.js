...
const COMPORTAMIENTO = [
  ...
  ['cheques: un común muestra la fecha de pago vacía en vez de "Al día"',
    ": 'Al día'", ': formatearFechaCob(ch.fecha_pago)'],
  ['cheques: un depositado no se atenúa',
    "const salido = ch.estado === 'depositado' || ch.estado === 'endosado'", "const salido = ch.estado === 'endosado'"],
