...
correrMutaciones({
  ...
  manuales: [
    ...
    { nombre: 'el texto vuelve al viejo (el que pone JS)',
      ...
      a: "    const TEXTO_BOTON_CHEQUE_MANO = '+ Agregar cheque a mano'" },
    { nombre: 'el texto vuelve al viejo (el del HTML)',
      de: 'aria-describedby="cob-ayuda-cheque-mano">+ Agregar un cheque que no se leyó</button>',
      a: 'aria-describedby="cob-ayuda-cheque-mano">+ Agregar cheque a mano</button>' },
    { nombre: 'el disabled va como atributo del HTML',
      de: 'id="cob-btn-cheque-mano" aria-describedby', a: 'id="cob-btn-cheque-mano" disabled aria-describedby' },
